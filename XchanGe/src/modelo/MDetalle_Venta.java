...
public class MDetalle_Venta {
    ...
    public MDetalle_Venta(int cod_detalle, int cantidad_detalle, long precio_producto, long cod_productoFK, int cod_ventaFK, long subtotal, long subPrecioCompra, long precio_compra) {
