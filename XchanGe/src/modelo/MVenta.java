...
public class MVenta {
    ...
    public MVenta(int cod_venta, Date fecha_venta, long total_venta, int cod_usuarioFK, int cod_clienteFK,String tipo_comprobante,int num_factura, long pago, int descuento) {
